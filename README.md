...
Download [the latest AAR](https://repo1.maven.org/maven2/com/jaredrummler/material-spinner/1.0.1/material-spinner-1.0.1.aar) or grab via Gradle:

```groovy
compile 'com.jaredrummler:material-spinner:1.0.1'
```
or Maven:
```xml
<dependency>
